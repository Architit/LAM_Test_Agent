...
MODULE_PATH = REPO_ROOT / "scripts" / "global" / "task_spec_validator.py"
TEMPLATE_PATH = REPO_ROOT / "devkit" / "task_spec_template.yaml"
CONTRACT_PATH = REPO_ROOT / "contract" / "global" / "TASK_SPEC_VALIDATOR_CONTRACT_V1_1.md"
